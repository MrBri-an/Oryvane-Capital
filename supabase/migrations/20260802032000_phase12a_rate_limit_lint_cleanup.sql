-- Phase 12A follow-up: remove the unused return target reported by linked plpgsql_check.
...
declare current_count integer; observed_at timestamptz:=clock_timestamp();
begin
